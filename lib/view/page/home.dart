...
import 'package:klio_staff/controller/home_controller.dart';
import 'package:klio_staff/service/api/api_client.dart';
import 'package:klio_staff/view/page/drawer.dart';
                                  ...
                                  return Padding(
                                    ...
                                    child: MaterialButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          homeController.getMenuByCategory(id: homeController.category.value.data![index].id!);
                                        },
                                        shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(8.0),
                                        ),
                                        child: Text(
                                          homeController.category.value.data![index].name.toString(),
                                          style: TextStyle(
                                              color: selectedCategory == index
                                                  ? white
                                                  : primaryText),
                                            ...
                                            gridImage
                                                ? Expanded(
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        homeController.menu.value.data![index].image.toString(),
                                                      ),
                                                    ),
                                                  )
                                                : SizedBox(),
                                                      ...
                                                      Expanded(
                                                        child:
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                homeController.menu.value.data![index].name.toString(),
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        fontMediumExtra,
                                                                    color:
                                                          ...
                                                          : Padding(
                                                              padding:
                                                                  const EdgeInsets
                                                                      ...
                                                                      0, 0, 10, 0),
                                                              child: Text(
                                                                homeController.menu.value.data![index].price.toString(),
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        fontMediumExtra,
                                                                    color:
