...
class FinanceManagement extends StatefulWidget {
  ...
  @override
  State<FinanceManagement> createState() => _FinanceManagementState();
}

class _FinanceManagementState extends State<FinanceManagement>with SingleTickerProviderStateMixin {
